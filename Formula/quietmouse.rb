# Generated by scripts/update-formula.sh from the v0.1.25 release. Don't edit by hand.
class Quietmouse < Formula
  ...
  on_macos do
    on_arm do
      url "https://github.com/benjweaver/quietmouse/releases/download/v0.1.25/quietmouse-v0.1.25-macos-universal.tar.gz"
      sha256 "a8ffd4ceda789cce72f7ccb46360b025cf2113a43ba4901976de288673ae2314"
    end
    on_intel do
      url "https://github.com/benjweaver/quietmouse/releases/download/v0.1.25/quietmouse-v0.1.25-macos-universal.tar.gz"
      sha256 "a8ffd4ceda789cce72f7ccb46360b025cf2113a43ba4901976de288673ae2314"
  ...
  on_linux do
    on_intel do
      url "https://github.com/benjweaver/quietmouse/releases/download/v0.1.25/quietmouse-v0.1.25-linux-x86_64.tar.gz"
      sha256 "4efbe23c78c99e2271a2981dd5fe04333e55c13d2c93dea436e7aa51c83a378a"
    end
  end
