# Generated by scripts/update-formula.sh from the v0.1.24 release. Don't edit by hand.
class Quietmouse < Formula
  ...
  on_macos do
    on_arm do
      url "https://github.com/benjweaver/quietmouse/releases/download/v0.1.24/quietmouse-v0.1.24-macos-universal.tar.gz"
      sha256 "bd9d4460bec24f1b9aac0bb8c8af1f04d30d67c3236221aace202e6b3bcb5028"
    end
    on_intel do
      url "https://github.com/benjweaver/quietmouse/releases/download/v0.1.24/quietmouse-v0.1.24-macos-universal.tar.gz"
      sha256 "bd9d4460bec24f1b9aac0bb8c8af1f04d30d67c3236221aace202e6b3bcb5028"
  ...
  on_linux do
    on_intel do
      url "https://github.com/benjweaver/quietmouse/releases/download/v0.1.24/quietmouse-v0.1.24-linux-x86_64.tar.gz"
      sha256 "15aff4edd9955799a75067fac71bfec54e6be67ef430cf8ed976ff16464e54b0"
    end
  end
