# Generated by scripts/update-formula.sh from the v0.1.23 release. Don't edit by hand.
class Quietmouse < Formula
  ...
  on_macos do
    on_arm do
      url "https://github.com/benjweaver/quietmouse/releases/download/v0.1.23/quietmouse-v0.1.23-macos-universal.tar.gz"
      sha256 "56e5a89d1223b790749c26689b2bc503733660d7b6eb6f75f64792d7729e2450"
    end
    on_intel do
      url "https://github.com/benjweaver/quietmouse/releases/download/v0.1.23/quietmouse-v0.1.23-macos-universal.tar.gz"
      sha256 "56e5a89d1223b790749c26689b2bc503733660d7b6eb6f75f64792d7729e2450"
  ...
  on_linux do
    on_intel do
      url "https://github.com/benjweaver/quietmouse/releases/download/v0.1.23/quietmouse-v0.1.23-linux-x86_64.tar.gz"
      sha256 "72195ec26c0fb29d3700e7995721ba6a7382de374b225d3a78ead245dd8baeec"
    end
  end
