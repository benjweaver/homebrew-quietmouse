# Generated by scripts/update-formula.sh from the v0.1.26 release. Don't edit by hand.
class Quietmouse < Formula
  ...
  on_macos do
    on_arm do
      url "https://github.com/benjweaver/quietmouse/releases/download/v0.1.26/quietmouse-v0.1.26-macos-universal.tar.gz"
      sha256 "3ef5295a757556a3d6b28e522d5133f7f3651c641084d0c6d09842c1849a1012"
    end
    on_intel do
      url "https://github.com/benjweaver/quietmouse/releases/download/v0.1.26/quietmouse-v0.1.26-macos-universal.tar.gz"
      sha256 "3ef5295a757556a3d6b28e522d5133f7f3651c641084d0c6d09842c1849a1012"
  ...
  on_linux do
    on_intel do
      url "https://github.com/benjweaver/quietmouse/releases/download/v0.1.26/quietmouse-v0.1.26-linux-x86_64.tar.gz"
      sha256 "0814d8950af7cef975858e5f8085d6a517d1c60c30d2eebf4bb0fafeb366443a"
    end
  end
